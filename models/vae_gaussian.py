...
class GaussianVAE(Module):
    ...
    def get_loss(self, x, writer=None, it=None, kl_weight=1.0):
        ...
        """
        #pc = pc_kit.index_points(x,pc_kit.farthest_point_sample_batch(x,256))
    ...
    def sample(self, z, num_points, flexibility,sampled_pc ,truncate_std=None):
        """
        Args:
        ...
        samples = self.diffusion.sample(num_points, context=z,sampled_pc=sampled_pc, flexibility=flexibility)
