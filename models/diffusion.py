...
class DiffusionPoint(Module):
    ...
    def sample(self, num_points, context,sampled_pc, point_dim=3, flexibility=0.0, ret_traj=False):
    # def sample(self, num_points, context,point_dim=3, flexibility=0.0, ret_traj=False):
        batch_size = context.size(0)
        # pc = noise_Gaussian(torch.repeat_interleave(sampled_pc,8,dim=1) , 0.1)
        # x_T = pc.to(context.device)
